...
const SHERLOCK_FLAKE_SYSTEM_PROMPT = [
  ...
  '  * 0.90-1.00: retry-pass-rate signal is strong AND timing pattern matches a known flake class; you would bet your reputation.',
  '  * 0.75-0.89: strong evidence for one flake cause, but a second is conceivable.',
  '  * 0.60-0.74: two flake causes are roughly equally plausible.',
  '  * 0.50-0.59: genuinely ambiguous OR thin retry history — mark for human review.',
