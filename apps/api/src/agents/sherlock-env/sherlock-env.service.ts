...
const SHERLOCK_ENV_SYSTEM_PROMPT = [
  ...
  '  * 0.90-1.00: stack trace explicitly names env state AND logs corroborate; you would bet your reputation.',
  '  * 0.75-0.89: strong evidence for one env cause, but a second is conceivable.',
  '  * 0.60-0.74: two env causes are roughly equally plausible.',
