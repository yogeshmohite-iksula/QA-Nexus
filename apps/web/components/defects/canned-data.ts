...
// finding — Day-18 had invented variant "Search defects, IDs, JIRA,
// comments…" which paraphrased rather than copied verbatim).
export const F21_SEARCH_PLACEHOLDER = 'Search by ID, title, ticket #…';
