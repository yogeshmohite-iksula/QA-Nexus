// Left navigation rail for F08b Home (QA Lead).
// Lead variant: ALL sections visible (Plan / Author / Run / Analyse / Govern)
// vs F08a's QA Engineer view which omits QA Value + Govern.
...
const SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'defects', label: 'Defects / Failures', count: { value: '47', tone: 'fail' } },
      { id: 'reports', label: 'Reports' },
      { id: 'qa-value', label: 'QA Value' },
    ],
  },
  {
    id: 'govern',
    title: 'Govern',
    items: [
      { id: 'agents', label: 'Agents', count: { value: '9', tone: 'neutral' } },
